...
export default function StudentsImport({ imports: importLogs }: ImportPageProps) {
    ...
    const getProgressUrl = useCallback((id: number): string => {
        return imports.students.progress.url(id);
    }, []);
            ...
            <div className="px-6 py-10 md:px-10">
                <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Upload an Excel file to bulk import student
                                    records.
                                </p>
                            </div>
                        </div>
                        ...
                        <ImportUploadCard
                            ...
                            description="Upload an Excel file (.xlsx, .xls) or CSV file containing student information. Download the template first for the correct format."
                            storeUrl={imports.students.store.url()}
                            templateUrl={imports.students.template.url()}
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Recent student import activity
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                {importLogs.length === 0 ? (
